<template>
  <BasicModal v-bind="$attrs" @register="registerModal" :title="title" :width="800" @ok="handleSubmit">
    <sys-roles-form ref="formComponent" :formDisabled="formDisabled" :formBpm="false" @success="submitSuccess"></sys-roles-form>
  </BasicModal>
</template>
...
<script lang="ts">
  ...
  import SysRolesForm from './SysRolesForm.vue';
