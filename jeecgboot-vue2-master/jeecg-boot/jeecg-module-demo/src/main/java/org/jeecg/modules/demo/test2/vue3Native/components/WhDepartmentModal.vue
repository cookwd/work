<template>
  <BasicModal v-bind="$attrs" @register="registerModal" :title="title" :width="800" @ok="handleSubmit">
    <wh-department-form ref="formComponent" :formDisabled="formDisabled" :formBpm="false" @success="submitSuccess"></wh-department-form>
  </BasicModal>
</template>
...
<script lang="ts">
  ...
  import WhDepartmentForm from './WhDepartmentForm.vue';
